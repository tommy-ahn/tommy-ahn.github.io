 ...
 <tbody>
    <tr>
      <td style="padding:20px;width:30%;max-width:30%" align="center">
        <img style="width:100%;max-width:100%" src="../../ads.png" alt="dise">
      </td>
      <td width="75%" valign="center">
        ...
        <br>
        <em>Conference on IEEE/CVF Winter Conference on Applications of Computer Vision (WACV) (<strong>WACV</strong>)</em>, 2023
        <br>
