...
<br>    
### Patents     
- 고병철, 안다솜, 비디오의 장단기 의존성을 이용한 시간적 행동 검출 장치 및 방법 (APPARATUS AND METHOD FOR TEMPORAL ACTION DETECTION USING SHORT- AND LONG-TERM DEPENDENCIES) 등록번호(일자) ******** (2026.**.**) (연구재단, 지역대학우수,2025 종료과제) 
- 고병철, 안다솜, 설명 가능한 인공지능을 위한 에너지 앙상블 개념 병목 모델 장치 및 방법 (ENERGY ENSEMBLE CONCEPT BOTTLENECK MODEL APPARATUS AND METHOD FOR EXPLAINABLE ARTIFICIAL INTELLIGENCE) 등록번호(일자) ******** (2026.**.**) (연구재단, 이공학학술연구기반구축) 
