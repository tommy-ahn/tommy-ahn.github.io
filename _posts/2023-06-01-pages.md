...
<table style="width:100%; border-collapse:collapse; font-size:14pt;">
  <tbody>
    ...
    <tr style="border-bottom:1px solid #ddd;">
      <td style="width:15%; padding:12px; vertical-align:top; color:#555;">
        ICCVW 2025
      </td>
      <td style="padding:12px;">
        <strong>Flow-Guided Policies: Overcoming Diffusion Limitations for Robust Robot Imitation Learning</strong><br>
        Chanhyuk Jung, Sangwon Kim, Kwang-Ju Kim, <strong>Dasom Ahn</strong>, Joonki Baek, Sungkeun Yoo, Byoung Chul Ko<br>
    ...
    <tr style="border-bottom:1px solid #ddd;">
      <td style="padding:12px; color:#555;">ACCV 2024</td>
      <td style="padding:12px;">
        <strong>EQ-CBM: A Probabilistic Concept Bottleneck with Energy-based Models and Quantized Vectors</strong><br>
        Sangwon Kim, <strong>Dasom Ahn</strong>, Byoung Chul Ko, In-su Jang, Kwang-Ju Kim<br>
    ...
    <tr style="border-bottom:1px solid #ddd;">
      <td style="padding:12px; color:#555;">ICML 2024</td>
      <td style="padding:12px;">
        <strong>Scene Graph Generation Strategy with Co-occurrence Knowledge and Learnable Term Frequency</strong><br>
        Hyeongjin Kim, Sangwon Kim, <strong>Dasom Ahn</strong>, Jong Taek Lee, Byoung Chul Ko<br>
        <a href="#">[arXiv]</a>
      </td>
    </tr>

    <tr style="border-bottom:1px solid #ddd;">
      <td style="padding:12px; color:#555;">ICCV 2023</td>
      <td style="padding:12px;">
        <strong>Cross-Modal Learning with 3D Deformable Attention for Action Recognition</strong><br>
        Sangwon Kim, <strong>Dasom Ahn</strong>, Byoung Chul Ko<br>
        <a href="https://arxiv.org/pdf/2212.05638.pdf">[arXiv]</a>
      </td>
    </tr>

    <tr style="border-bottom:1px solid #ddd;">
      <td style="padding:12px; color:#555;">WACV 2023</td>
      <td style="padding:12px;">
        <strong>STAR-Transformer: A Spatio-temporal Cross Attention Transformer for Human Action Recognition</strong><br>
        <strong>Dasom Ahn</strong>, Sangwon Kim, Hyunsu Hong, Byoung Chul Ko<br>
