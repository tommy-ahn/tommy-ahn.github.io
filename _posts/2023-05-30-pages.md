  ...
  <tbody>
     <tr>
       ...
       <td width="75%" valign="center">
         <strong><papertitle style="font-site:14pt;">STAR-Transformer: A Spatio-temporal Cross Attention Transformer for Human Action Recognition</strong>
         <br>
     ...
     <tr>
       ...
       <td width="75%" valign="center">
         <strong><papertitle style="font-site:14pt;">Shift-ViT: Siamese Vision Transformer using Shifted Branches</strong>
         <br>
         <strong>Dasom Ahn</strong>, 
