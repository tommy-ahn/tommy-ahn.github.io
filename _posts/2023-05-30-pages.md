  ...
  <tbody>
     <tr>
       ...
       <td width="75%" valign="center">
         <strong><u>
          <p style="font-size:16pt; line-height: 10px; text-indent:-16px;">STAR-Transformer: A Spatio-temporal Cross Attention Transformer for Human Action Recognition</p>
          </u></strong>
     ...
     <tr>
       ...
       <td width="75%" valign="center">
         <strong><u>
          <p style="font-size:16pt; line-height: 10px; text-indent:-16px; text-decoration: underline;">Shift-ViT: Siamese Vision Transformer using Shifted Branches</p>
          </u></strong>
         <strong>Dasom Ahn</strong>, 
