  ...
  <tbody>
     <tr>
       ...
       <td width="75%" valign="center">
         <strong><p style="font-site:16pt; line-height: 10px; text-indent:-30px;">STAR-Transformer: A Spatio-temporal Cross Attention Transformer for Human Action Recognition</p></strong>
     ...
     <tr>
       ...
       <td width="75%" valign="center">
         <strong><p style="font-site:16pt; line-height: 10px; text-indent:-30px;">Shift-ViT: Siamese Vision Transformer using Shifted Branches</p></strong>
         <strong>Dasom Ahn</strong>, 
